...
class EditarServico extends StatelessWidget {
  const EditarServico({ Key? key }) : super(key: key);
                ...
                children: [
                  ...
                  TextField(
                    ...
                    decoration: InputDecoration.collapsed(
                      ...
                      hintStyle: TextStyle(fontWeight: FontWeight.bold, fontSize: 18, color: Colors.black),
                    ),
                  ),
                ],
              ),
                ...
                child: SizedBox.expand(
                  child:TextButton(
                    child: const Row(
                      ...
                      children: <Widget> [
                        Text("Salvar", style: TextStyle(fontWeight: FontWeight.bold, color: Colors.white, fontSize: 18,
                        ),
                        ),
                      ],
                      ),
